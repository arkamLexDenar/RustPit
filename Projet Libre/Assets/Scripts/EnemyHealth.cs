...
//		this.hitParticles = this.GetComponentInChildren<ParticleSystem>();
//		this.capsuleCollider = this.GetComponent<CapsuleCollider>();
	...
	void Update()
	{
		...
		if (this.isSinking)
		{
			...
			this.transform.Translate (-Vector3.up * this.sinkSpeed * Time.deltaTime);
		}
	}
...
//		enemyAudio.Play ();
	...
	public void StartSinking()
	{
		...
		this.Destroy(this.gameObject, 2f);
	}
}